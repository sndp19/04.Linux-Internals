//Question) A09 - Implement communication between two related processes using one pipe 
/* ============================================================================================================================================
...
Requirements  	 :	Create three child process and execute commands passed from command-line arguments 
...
Sample execution :	1) ./three_pipes (No arguments)

 			Error: No arguments passed Usage: ./three_pipes  <command1 > '|'   <command2> '|'  <command3 >    2> 1>  2> 2> 1>  2>   2> 1>

			2) ./pipe ls ­l '|' grep 

 			Error: Insufficient arguments passed Usage: ./pipe  <command1 > '|'   <command2> '|'  <command3 > 1> 1>
